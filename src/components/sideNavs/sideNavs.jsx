    ...
    <div className="sideNavs">
      <div className="left_sidenav">
        <ul >
          <li>
            <a
              href="https://github.com/rajeshkrishnait"
              aria-label="GitHub"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/rajesh-krishna-904943146/"
              aria-label="Linkedin"
              target="_blank"
              rel="noreferrer"
            >
      ...
      <div className="right_sideNav"> 
            <div onClick={() => top.current.scrollIntoView({ behavior: "smooth" })}class="arrow"></div>
      </div>
    </div>
  );
};
